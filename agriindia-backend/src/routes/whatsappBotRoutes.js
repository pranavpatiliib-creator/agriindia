...
const I18N = {
  ...
  mr: {
    ...
    msp_all_heading: "सर्व पिकांचे MSP",
    msp_kharif_heading: "खरीप पिके - MSP 2026-27 (रु./क्विंटल)",
    msp_kharif_source: "(स्त्रोत: भारत सरकार - MSP अधिसूचना)",
    msp_rabi_heading: "रब्बी पिके - MSP 2026-27 (रु./क्विंटल)",
    msp_rabi_source: "(स्त्रोत: अधिकृत सरकारी अधिसूचना)",
  ...
  hi: {
    ...
    msp_all_heading: "सभी फसलों का MSP",
    msp_kharif_heading: "खरीफ फसलें - MSP 2026-27 (रु./क्विंटल)",
    msp_kharif_source: "(स्रोत: भारत सरकार - MSP अधिसूचना)",
    msp_rabi_heading: "रबी फसलें - MSP 2026-27 (रु./क्विंटल)",
    msp_rabi_source: "(स्रोत: आधिकारिक सरकारी अधिसूचना)",
...
function buildAllCropsMspText(language = "en") {
  ...
  const lists = {
    ...
    mr: {
      kharif: [
        "धान - सामान्य: 2,369",
        "धान - ग्रेड A: 2,389",
        "ज्वारी - हायब्रिड: 3,699",
        "ज्वारी - मालदांडी: 3,749",
        "बाजरी: 2,775",
        "नाचणी: 4,290",
        "मका: 2,400 (अंदाजे)",
        "तूर / अरहर: 8,000 (अंदाजे)",
        "मूग: 8,682 (अंदाजे)",
        "उडीद: 7,400 (अंदाजे)",
        "भुईमूग: 6,783 (अंदाजे)",
        "सूर्यमुखी बियाणे: 7,280 (अंदाजे)",
        "सोयाबीन (पिवळे): 5,328 (अंदाजे)",
        "तीळ: 9,267 (अंदाजे)",
        "रामतिळ: 8,717 (अंदाजे)",
        "कापूस - मिडियम स्टेपल: 7,710",
        "कापूस - लाँग स्टेपल: 8,110",
      ],
      rabi: [
        "गहू: 2,585",
        "बार्ली: 2,150",
    ...
    hi: {
      kharif: [
        ...
        "उड़द: 7,400 (लगभग)",
        "मूंगफली: 6,783 (लगभग)",
        "सूरजमुखी बीज: 7,280 (लगभग)",
        "सोयाबीन (पीला): 5,328 (लगभग)",
        "तिल: 9,267 (लगभग)",
        "नाइजरसीड: 8,717 (लगभग)",
        "कपास - मीडियम स्टेपल: 7,710",
        "कपास - लॉन्ग स्टेपल: 8,110",
      ],
      rabi: [
        "गेहूं: 2,585",
        "जौ: 2,150",
  ...
  const selected = lists[lang] || lists.en;
  const kharif = selected.kharif;
  const rabi = selected.rabi;
